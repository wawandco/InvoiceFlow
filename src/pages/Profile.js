      ...
      {isAuthenticated &&
        <div className="flex flex-row min-h-[calc(100vh-100px)] justify-center items-center">
          <div className="flex flex-col justify-center max-w-lg p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
            <img src={user.picture} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
            <div className="space-y-4 text-center divide-y dark:divide-gray-300">
              ...
              <div className="flex justify-center pt-2 space-x-4 align-center">
                <a rel="noopener noreferrer" href="/" aria-label="GitHub" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-[#3D52A0]">
                ...
                <a rel="noopener noreferrer" href="/" aria-label="Dribble" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-[#3D52A0]">
                ...
                <a rel="noopener noreferrer" href="/" aria-label="Twitter" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-[#3D52A0]">
                  <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                ...
                <a rel="noopener noreferrer" href="/" aria-label="Email" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-[#3D52A0]">
                  <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
